...
writeTauIdDiscrMVAs = cms.EDAnalyzer("GBRForestWriter",
    jobs = cms.VPSet(
        ...
        cms.PSet(
            ...
            outputFileType=cms.string("SQLLite"),
            outputRecord=cms.string("RecoTauTag_tauIdMVAIsoPhase2")
       ),
    )
)
    ...
    jobs=cms.VPSet(
        ...
        # Phase 2
            cms.PSet(
                ...
                graphName=cms.string("tauIdMVAIsoPhase2Eff95"),
                outputRecord=cms.string("RecoTauTag_tauIdMVAIsoPhase2_WPEff95")
            ),
            cms.PSet(
                inputFileName=cms.FileInPath("wpDiscriminationByIsolationMVAPhase2_tauIdMVAIsoPhase2.root"),
                graphName=cms.string("tauIdMVAIsoPhase2Eff90"),
                outputRecord=cms.string("RecoTauTag_tauIdMVAIsoPhase2_WPEff90")
            ),
            cms.PSet(
                inputFileName=cms.FileInPath("wpDiscriminationByIsolationMVAPhase2_tauIdMVAIsoPhase2.root"),
                graphName=cms.string("tauIdMVAIsoPhase2Eff80"),
                outputRecord=cms.string("RecoTauTag_tauIdMVAIsoPhase2_WPEff80")
            ),
            cms.PSet(
                inputFileName=cms.FileInPath("wpDiscriminationByIsolationMVAPhase2_tauIdMVAIsoPhase2.root"),
                graphName=cms.string("tauIdMVAIsoPhase2Eff70"),
                outputRecord=cms.string("RecoTauTag_tauIdMVAIsoPhase2_WPEff70")
            ), 
            cms.PSet(
                inputFileName=cms.FileInPath("wpDiscriminationByIsolationMVAPhase2_tauIdMVAIsoPhase2.root"),
                graphName=cms.string("tauIdMVAIsoPhase2Eff60"),
                outputRecord=cms.string("RecoTauTag_tauIdMVAIsoPhase2_WPEff60")
            ),
            cms.PSet(
                inputFileName=cms.FileInPath("wpDiscriminationByIsolationMVAPhase2_tauIdMVAIsoPhase2.root"),
                graphName=cms.string("tauIdMVAIsoPhase2Eff50"),
                outputRecord=cms.string("RecoTauTag_tauIdMVAIsoPhase2_WPEff50")
            ),
            cms.PSet(
                inputFileName=cms.FileInPath("wpDiscriminationByIsolationMVAPhase2_tauIdMVAIsoPhase2.root"),
                graphName=cms.string("tauIdMVAIsoPhase2Eff40"),
                outputRecord=cms.string("RecoTauTag_tauIdMVAIsoPhase2_WPEff40")
            ),
    )
)
...
writeTauIdDiscrMVAoutputNormalizations = cms.EDAnalyzer("TFormulaWriter",
    jobs=cms.VPSet(
        ...
        cms.PSet(
            inputFileName=cms.FileInPath('wpDiscriminationByIsolationMVAPhase2_tauIdMVAIsoPhase2.root'),
            formulaName=cms.string("mvaOutput_normalization_tauIdMVAIsoPhase2"),
            outputRecord=cms.string("RecoTauTag_tauIdMVAIsoPhase2_mvaOutput_normalization")
        ),
    )
)
